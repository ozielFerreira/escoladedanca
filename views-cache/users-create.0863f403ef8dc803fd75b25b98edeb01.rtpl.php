          ...
          <form role="form" action="/admin/users/create" method="post">
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <input type="tel" class="form-control" id="nrphone" name="nrphone" placeholder="Digite o telefone" maxlength="12">
              </div>
              <div class="form-group">
              ...
              <div class="checkbox hidden">
                <label>
                  <input type="checkbox hidden" name="inadmin" value="1" checked=""> Acesso de Administrador
                </label>
              </div>
            </div>
            <!-- /.box-body -->
