      ...
      <!-- begin login -->
        <div class="login login-v2" data-pageload-addclass="animated fadeIn">
            ...
            <div class="login-header">
                <div class="brand">
                    <!-- <span class="logo"></span> --> <img src="/res/site/img/logo-academia.jpg" alt="Jaime Arôxa Niterói" style="width: 55px; border-radius: 5%;box-shadow: 1px 3px 3px rgba(0, 0, 0, 0.77);"> <b>Painel</b> Admin
                    <small>Escola de dança Jaime Arôxa NIterói</small>
                </div>
                <div class="icon">
